var cursoreffects = function(t) {
    ...
    t.ghostCursor = function(t) {
        let e, n, i, o = t && t.element, s = o || document.body, h = t && t.randomDelay, c = t && t.minDelay || 5, l = t && t.maxDelay || 50, a = window.innerWidth, r = window.innerHeight, d = {
            x: a / 2,
            y: a / 2
        }, u = [], A = new Image;
        ...
        function f(t) {
            ...
            r = window.innerHeight,
            o ? (e.width = s.clientWidth,
            e.height = s.clientHeight) : (e.width = a,
            e.height = r)
        }
        function p(t) {
            if (t.touches.length > 0)
